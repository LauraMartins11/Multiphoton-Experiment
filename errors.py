...
SIGMA_HWP_ARYA=0.03*np.pi/180
SIGMA_QWP_ARYA=0.116*np.pi/180
SIGMA_HWP_BRAN=0.022*np.pi/180
SIGMA_QWP_BRAN=0.05*np.pi/180
SIGMA_HWP_CERSEI=0.0667*np.pi/180
SIGMA_QWP_CERSEI=0.172*np.pi/180
SIGMA_HWP_DANY=0.026*np.pi/180
SIGMA_QWP_DANY=0.231*np.pi/180