...
### With this class we want to be able to easily calculate all these quantities regarding our state
    ...
    def optimize(self, data_points, *fargs, bounds=None, penalty=None):
        params=diffev2(self.function, self.initial_guess, args=(data_points, *fargs), penalty=penalty, strategy=Best1Bin, bounds=bounds, npop=50, gtol=100, disp=False, ftol=1e-8, handler=False)#VerboseMonitor(50), handler=False)
